...
```text
VITE_SERVER_URL=https://crazy-racing.onrender.com
```
...
|----------|----------|-------------|
| `NODE_ENV` | ✅ | `production` |
| `NODE_VERSION` | ✅ | Node version used during deployment |
| `CLIENT_URLS` | ✅ | Allowed frontend origins |
| `APP_VERSION` | Optional | Version exposed by `/health` |
...
CLIENT_URLS=https://crazy-racing.pages.dev
APP_VERSION=0.5.0
LOG_LEVEL=info
```
...
```text
CLIENT_URLS=https://crazy-racing.pages.dev,https://preview.pages.dev
```
